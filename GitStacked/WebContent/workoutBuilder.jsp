	...
	<body onload = "dateSetter();">
		...
		<form name="createWorkout" action="createWorkout2.do" method="POST">
			<div id="formelements">
				...
				<br> <!-- in general it's better to use css then these -->
				<label>Or create a new workout</label>
				<input type="text" name="newWorkoutName" value=" ">
				<br>
			...
			<div id="target">
				<label>Date:</label><input type="text" id="datepicker" name="date"></p>
